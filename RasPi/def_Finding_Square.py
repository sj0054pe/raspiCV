...
def pull_the_base_Coordinates(theDate, Season,RasPi_SerialNum, num_of_object):
    print("[スケールの検出]")
    role="Base"
    Latest_Coordinates_List=def_Browse_data_on_CSV.pull_the_latest_Coordinates(theDate, Season, role,RasPi_SerialNum, num_of_object)
